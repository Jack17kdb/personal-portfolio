...
const Contact = () => {
  ...
  return (
    <section
      className="min-h-screen flex items-center justify-center py-20 bg-gradient-to-br from-black via-gray-900 to-gray-950 text-white"
      id="contact"
    >
      <div className="max-w-5xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 px-6 lg:px-10">
        ...
        <form
          ...
          className="flex flex-col items-center justify-center gap-5 bg-white/5 border border-white/10 rounded-2xl p-6 lg:p-8 backdrop-blur-md shadow-lg"
        >
          ...
          <label className="relative w-full max-w-md">
            <span className="absolute left-3 top-5 text-gray-400">
              <FiMessageSquare />
            </span>
            <textarea
              name="message"
              ...
              className="w-full pl-12 pr-4 pt-4 pb-4 min-h-[120px] rounded-xl bg-white/5 border border-white/10 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-400 transition resize-y align-top"
